...
// 1. Write a function called first that returns the first item of the array using a callback function
  ...
  // Code Here
let first = function(names, callback){
  callback(names[0])
}
...
// 2. Write a function called last which returns the last item of the array using a callback function.
  ...
  //Code Here
let last = function(names, callback){
...
// 3. Write a function called multiply that multiplies two numbers using a callback function.
  ...
  //Code Here
let multiply = function(numb1, numb2, multi) {
  multi(numb1 * numb2)
}
...
let uniq = function(names, callback) {
  callback(names.filter(function(elem, index, self) {
...
// function to return the indices and item.
    ...
    //Code Here 
let each = function(names, callback){
  for (let i = 0; i < names.length; i++){
    callback(names[i], i)
  }
}
